...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['dataset-administrator', 'dataset-owner', 'dataset-contributor', 'dataset-reviewer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Datasets', path: '/datasets', entity: 'dataset', service: AccessServiceEnum.PROJECT, icon: FiDatabase },
    { name: 'Reviews', path: '/reviews', entity: 'review', service: AccessServiceEnum.PROJECT, icon: FiMessageCircle },
